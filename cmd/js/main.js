...
location.reload();
        ...
        setTimeout(function(){ document.location.href = 'https://www.flickr.com/photos/gocivici'; }, 2500);
    ...
    sudo: function() {
        this.echo("Ohhhh jeeez boi/gurl. A smart one. Who are you?")
        if(ga != undefined) ga('send', 'event', 'su');
    },
    about: function() {
        this.echo("\tThis page built with <a href='http://terminal.jcubic.pl/' target='_blank' style=''>jQuery Terminal Emulator</a> plugin, and hosted by <a href='http://www.cs.bilkent.edu.tr/~david/cs101/practicalwork/defaultFolderSetup.htm' target='_blank' style=''>Bilkent University Servers<a/>. Source code is also available on <a href='https://github.com/gocivici' target='_blank'>GitHub</a>.<br/>This page is under development..", {raw:true});
...
function showHelp(consoleObj)
{
        ...
        consoleObj.echo("\t[[b;#44D544;]whoami]            short bio about me");
